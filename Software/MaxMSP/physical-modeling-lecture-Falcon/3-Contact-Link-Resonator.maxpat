{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 180.0, 114.0, 997.0, 274.0 ],
		"bglocked" : 0,
		"defrect" : [ 180.0, 114.0, 997.0, 274.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Hint: For better sound, try changing m to 0.4 kg and contact c stiffness 12500 N/m.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 213.0, 127.0, 150.0, 20.0 ],
					"id" : "obj-8",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 213.0, 106.0, 150.0, 20.0 ],
					"id" : "obj-12",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"fontname" : "Arial",
					"patching_rect" : [ 146.0, 117.0, 84.0, 20.0 ],
					"id" : "obj-19",
					"fontsize" : 12.0,
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"floatoutput" : 1,
					"patching_rect" : [ 147.0, 117.0, 189.0, 20.0 ],
					"size" : 8.0,
					"id" : "obj-20"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "contact~ c 4500. 5.5 0.",
					"numinlets" : 2,
					"numoutlets" : 2,
					"presentation_rect" : [ 443.0, 94.0, 193.0, 27.0 ],
					"outlettype" : [ "signal", "signal" ],
					"fontname" : "Arial",
					"patching_rect" : [ 539.0, 23.0, 193.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontname" : "Arial",
					"patching_rect" : [ 366.0, 23.0, 114.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"patching_rect" : [ 782.0, 82.0, 157.0, 27.0 ],
					"presentation" : 1,
					"id" : "obj-18",
					"fontsize" : 18.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 847.0, 71.0, 150.0, 20.0 ],
					"id" : "obj-16",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 847.0, 60.0, 150.0, 20.0 ],
					"id" : "obj-15",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 847.0, 50.0, 150.0, 20.0 ],
					"id" : "obj-14",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"fontname" : "Arial",
					"patching_rect" : [ 780.0, 61.0, 84.0, 20.0 ],
					"id" : "obj-11",
					"fontsize" : 12.0,
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"floatoutput" : 1,
					"patching_rect" : [ 781.0, 61.0, 189.0, 20.0 ],
					"size" : 8.0,
					"id" : "obj-10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontname" : "Arial",
					"patching_rect" : [ 780.0, 22.0, 100.0, 27.0 ],
					"presentation" : 1,
					"color" : [ 0.960784, 0.439216, 0.478431, 1.0 ],
					"id" : "obj-5",
					"fontsize" : 18.0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 6.0, 6.0, 490.0, 198.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 310.5, 57.0, 333.0, 57.0, 356.0, 16.0, 374.0, 16.0, 375.5, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 375.5, 56.0, 357.0, 56.0, 331.0, 16.0, 310.5, 16.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 375.5, 56.0, 503.0, 56.0, 529.0, 16.0, 548.5, 16.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 548.5, 56.0, 530.0, 56.0, 503.0, 16.0, 375.5, 16.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 1 ],
					"hidden" : 0,
					"midpoints" : [ 789.5, 52.0, 764.0, 52.0, 742.0, 16.0, 722.5, 16.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 722.5, 53.0, 742.0, 53.0, 761.0, 16.0, 789.5, 16.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 375.5, 84.0, 526.5, 84.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 375.5, 84.0, 155.5, 84.0 ]
				}
