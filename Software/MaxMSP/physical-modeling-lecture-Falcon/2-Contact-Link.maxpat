{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 180.0, 114.0, 775.0, 302.0 ],
		"bglocked" : 0,
		"defrect" : [ 180.0, 114.0, 775.0, 302.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 424.0, 155.0, 150.0, 20.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 424.0, 144.0, 150.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 424.0, 134.0, 150.0, 20.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 76.0, 148.0, 128.0, 48.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 527.0, 143.0, 185.0, 27.0 ],
					"presentation" : 1,
					"id" : "obj-20",
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numinlets" : 1,
					"patching_rect" : [ 334.0, 145.0, 84.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "+ 10000.",
									"numinlets" : 2,
									"patching_rect" : [ 5.0, 104.0, 58.0, 20.0 ],
									"id" : "obj-9",
									"fontname" : "Arial",
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
...
, 			{
				"box" : 				{
					"maxclass" : "slider",
					"numinlets" : 1,
					"patching_rect" : [ 335.0, 145.0, 189.0, 20.0 ],
					"floatoutput" : 1,
					"id" : "obj-25",
					"numoutlets" : 1,
					"size" : 20000.0,
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 458.0, 89.0, 150.0, 20.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 458.0, 78.0, 150.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "|",
					"numinlets" : 1,
					"patching_rect" : [ 458.0, 68.0, 150.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "contact~ c 2000. 1.5 0.",
					"presentation_rect" : [ 136.0, 13.0, 193.0, 27.0 ],
					"numinlets" : 2,
					"patching_rect" : [ 161.0, 14.0, 193.0, 27.0 ],
					"presentation" : 1,
					"id" : "obj-17",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 391.0, 14.0, 100.0, 27.0 ],
					"presentation" : 1,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 400.5, 45.0, 384.0, 45.0, 358.0, 6.0, 340.0, 6.0, 344.5, 6.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 344.5, 45.0, 361.0, 45.0, 379.0, 6.0, 400.5, 6.0 ]
				}
